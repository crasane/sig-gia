                        ...
                        <div class="row">
                            <div class="col-xs-12 ml-auto mr-auto ie-container-width-fix">
                                <form action="index.html" method="get" class="tm-search-form tm-section-pad-2">
                                    <h1 style="color:white; font-size:56px;"><b>MAGELANG TRAVEL PACKAGE</b></h1>
                                </form>
                            </div>                        
                        </div>      
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col text-center">
                            ...
                            <p class="tm-color-white tm-section-subtitle">Interactive Map Location</p>
                            <a href="/map" class="tm-color-white tm-btn-white-bordered">Go to Map</a>
                        </div>                
                    </div>
                </div>        
            </div>
                ...
                <div class="container tm-pt-5 tm-pb-4">
                    <div class="row text-center">
                        <article class="col-sm-12 col-md-4 col-lg-4 col-xl-4 tm-article">                            
                            ...
                            <h3 class="tm-color-primary tm-article-title-1">Destinasi Terbaik</h3>
                            <p>Destinasi Terbaik Untuk Perjalanan Magelang Wisata</p>
                        </article>
                        <article class="col-sm-12 col-md-4 col-lg-4 col-xl-4 tm-article">                            
                            <i class="fa tm-fa-6x fa-plane tm-color-primary tm-margin-b-20"></i>
                            <h3 class="tm-color-primary tm-article-title-1">Booking Cepat & Tanpa Ribet Dengan Rasa Aman</h3>
                            <p>Booking melalui kami akan memberikan pelayanan terbaik buat kamu seperti Booking dengan cepat tanpa ribet  dengan rasa aman dan nyaman.</p>
                        ...
                        <article class="col-sm-12 col-md-4 col-lg-4 col-xl-4 tm-article">                           
                            ...
                            <h3 class="tm-color-primary tm-article-title-1">Gairah Perjalanan</h3>
                            <p>Tempat dimana yang akan membuat kamu tidak akan pernah lupa akan tempat ini karena perjalanan Anda akan diiringi oleh rasa gairah yang belum pernah kamu rasakan sebelumnya.</p>
                            <!-- <a href="#" class="text-uppercase tm-color-primary tm-font-semibold">Continue reading...</a> -->
                        </article>
                    </div>        
                </div>
            ...
            <div class="tm-section tm-section-pad tm-bg-gray" id="tm-section-4">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4" style="padding-top:20px;">

                            <div class="card" style="width: 18rem;">
                                <img class="card-img-top" src="/images/{{ $item->logo }}" alt="Card image cap" width="250px" height="180px">
                                <div class="card-body">
                                    <h5 class="card-title"><b>{{ $item->name }}</b></h5>
                                    <p class="card-text">Travel Type: {{ $item->travel_type }}</p>
                                    <p class="card-text">Address: {{ $item->address }}</p>
                                    <p class="card-text">Price: IDR {{ $item->price_from }} - IDR {{ $item->price_to }}</p>
